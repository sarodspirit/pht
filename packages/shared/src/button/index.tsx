...
const Button: React.FC<props> = ({children, size='default', type='primary', disabled=false})=>{
    ...
    return (<button disabled={disabled} className={className} type="button" style={{ transition: "all .15s ease" }}>
    {children}
  </button>)
}
